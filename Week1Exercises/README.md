...
**Task 3.1** What is the difference between `/dev/urandom` and `/dev/random` devices? Not also the [recent change on Kernel.](https://www.phoronix.com/scan.php?page=news_item&px=Linux-5.6-Random-Rework)
